...
class CompanySearch extends React.Component {
    _renderSearchResults() {
        return (
            <List size="large" itemLayout="vertical" bordered>
                    ...
                    return (
                        <List.Item
                            ...
                            <List.Item.Meta
                                ...
                                avatar={<img width={220} src="https://d1b10bmlvqabco.cloudfront.net/company/vmware/company_pic/1454537863_120.jpg"/>}/>
                        </List.Item>
                    );
                })}
            </List>
